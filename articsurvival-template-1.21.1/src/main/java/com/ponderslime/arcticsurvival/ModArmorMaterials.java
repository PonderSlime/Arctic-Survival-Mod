...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> SNOW_GEAR = registerMaterial("snow_gear",
            ...
            0.0F,
            0.0F,
            // Snow_Gear is NOT dyeable, so we will pass false.
            false);
            public static final int SNOW_GEAR_DURABILITY_MULTIPLIER = 15;
    ...
    public static RegistryEntry<ArmorMaterial> registerMaterial(String id, Map<ArmorItem.Type, Integer> defensePoints, int enchantability, RegistryEntry<SoundEvent> equipSound, Supplier<Ingredient> repairIngredientSupplier, float toughness, float knockbackResistance, boolean dyeable) {
        ...
        List<ArmorMaterial.Layer> layers = List.of(
                ...
                new ArmorMaterial.Layer(Identifier.of(ArcticSurvival.MOD_ID, id), "", dyeable)
        );

        ArmorMaterial material = new ArmorMaterial(defensePoints, enchantability, equipSound, repairIngredientSupplier, layers, toughness, knockbackResistance);
        // Register the material within the ArmorMaterials registry.
        material = Registry.register(Registries.ARMOR_MATERIAL, Identifier.of(ArcticSurvival.MOD_ID, id), material);
